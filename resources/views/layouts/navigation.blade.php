<nav x-data="{ open: false }" class="bg-white shadow-xl w-full sticky top-0 z-50 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('money-transfer.create')"
                                :active="request()->routeIs('money-transfer.create')">
